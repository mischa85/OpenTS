...
VQAErrorType Load_FINF(VQAHandleP *vqap, unsigned int iffsize);
VQAErrorType Load_CINF(VQAHandleP *vqap);
VQAErrorType Load_PINF(VQAHandleP *vqap);
VQAErrorType Load_LINF(VQAHandleP *vqap);
VQAErrorType Load_CLIP(VQAHandleP *vqap, unsigned int iffsize);
VQAErrorType Load_MFCI(VQAHandleP *vqap);

VQAErrorType Load_MSCI(VQAHandleP *vqap);

_STATIC VQAErrorType Load_VQF(VQAHandleP *vqap, unsigned int frame_iffsize, char flags);
_STATIC VQAErrorType Load_CBF0(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_CBFZ(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_CBP0(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_CBPZ(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_CPL0(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_CPLZ(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_VPT0(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_VPTZ(VQAHandleP *vqap, unsigned int iffsize);

#if(VQAAUDIO_ON)
_STATIC VQAErrorType Load_SND0(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_SND1(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_SND2(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_SN2J(VQAHandleP *vqap, unsigned int iffsize);
#endif

_STATIC VQAErrorType Load_LINH(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_LIND(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_CINH(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_CIND(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_PINH(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_PIND(VQAHandleP *vqap, unsigned int iffsize);

_STATIC VQAErrorType Load_MSCH(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_MSCT(VQAHandleP *vqap, unsigned int iffsize);

_STATIC VQAErrorType Load_MFCH(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_MFCD(VQAHandleP *vqap, unsigned int iffsize);
_STATIC VQAErrorType Load_MFCT(VQAHandleP *vqap, unsigned int iffsize);

_STATIC long VQA_GetCodebookSize(VQAHandleP *vqap, long framenum);
_STATIC VQAErrorType VQA_MFCIPrepare(VQAHandleP *vqap, unsigned int index);
...
_STATIC VQAErrorType VQA_MSCIPrepare(VQAHandleP *vqap, unsigned int index);
_STATIC VQAErrorType VQA_MSCIReadData(VQAHandleP *vqap, unsigned int iffsize, long index);

_STATIC long VQA_MFCIIndexFromChunkID(VQAHandleP *vqap, unsigned int chunkid);
_STATIC VQAErrorType VQA_MFCIReadData(VQAHandleP *vqap, unsigned int iffsize, long index);
...
VQAErrorType VQA_MFCIReadData(VQAHandleP *vqap, unsigned int iffsize, long index)
{
	void *buf;
	VQALoader *loader;
...
/// <returns>Returns with VQAERR_NONE if successful, or a VQAERR_??? error code.</returns>
VQAErrorType VQA_MSCIReadData(VQAHandleP *vqap, unsigned int iffsize, long index)
{
	VQAConfig *config;
	VQALoader *loader;
	unsigned int padsize;
...
VQAErrorType VQA_SeekLoop(VQAHandleP *vqap, long framenum, long flags)
{
	...
	if (rc == VQAERR_NONE) {
		if (needs_seek && vqap->Config.StreamHandler((VQAHandle *)vqap, VQACMD_SEEKPEEK, (void *)SEEK_SET, cache->Buffer + cache->Bytes) != 0) {
			return(VQAERR_SEEK);
		}
	}
...
VQAErrorType Load_VQF(VQAHandleP *vqap, unsigned int frame_iffsize, char flags)
{
	VQAFrameNode  *curframe;
	ChunkHeader   *chunk;
...
VQAErrorType Load_LINH(VQAHandleP *vqap, unsigned int iffsize)
{
...
VQAErrorType Load_LIND(VQAHandleP *vqap, unsigned int iffsize)
{
...
VQAErrorType Load_MFCH(VQAHandleP *vqap, unsigned int iffsize)
{
...
VQAErrorType Load_MFCD(VQAHandleP *vqap, unsigned int iffsize)
{
...
VQAErrorType Load_MFCT(VQAHandleP *vqap, unsigned int iffsize)
{
...
VQAErrorType Load_MSCH(VQAHandleP *vqap, unsigned int iffsize)
{
...
VQAErrorType Load_MSCT(VQAHandleP *vqap, unsigned int iffsize)
{
...
VQAErrorType VQA_MFCIPrepare(VQAHandleP *vqap, unsigned int index)
{
	VQAConfig *config;
	unsigned int size;
...
/// <returns>Returns with VQAERR_NONE if successful, or VQAERR_NOMEM if a buffer could not be allocated.</returns>
VQAErrorType VQA_MSCIPrepare(VQAHandleP *vqap, unsigned int index)
{
	VQAConfig *config;
	unsigned int size;
...
VQAErrorType Load_CINH(VQAHandleP *vqap, unsigned int iffsize)
{
...
VQAErrorType Load_CIND(VQAHandleP *vqap, unsigned int iffsize)
{
...
VQAErrorType Load_PINH(VQAHandleP *vqap, unsigned int iffsize)
{
...
VQAErrorType Load_PIND(VQAHandleP *vqap, unsigned int iffsize)
{
...
static VQAErrorType Load_VQHD(VQAHandleP *vqap, unsigned int iffsize)
{
	/* Read the header */
...
VQAErrorType Load_CBF0(VQAHandleP *vqap, unsigned int iffsize)
{
	VQALoader *loader;
	VQACBNode *curcb;
...
VQAErrorType Load_CBFZ(VQAHandleP *vqap, unsigned int iffsize)
{
	VQALoader     *loader;
	VQACBNode     *curcb;
	void          *buffer;
...
VQAErrorType Load_CBP0(VQAHandleP *vqap, unsigned int iffsize)
{
	VQALoader *loader;
	VQACBNode *curcb;
	VQAHeader *header;
...
VQAErrorType Load_CBPZ(VQAHandleP *vqap, unsigned int iffsize)
{
	VQAConfig     *config;
	VQALoader     *loader;
	VQACBNode     *curcb;
...
VQAErrorType Load_CPL0(VQAHandleP *vqap, unsigned int iffsize)
{
	VQADrawer *drawer;
	VQAFrameNode *curframe;
...
VQAErrorType Load_CPLZ(VQAHandleP *vqap, unsigned int iffsize)
{
	VQADrawer *drawer;
	VQAFrameNode  *curframe;
	void          *buffer;
...
VQAErrorType Load_VPT0(VQAHandleP *vqap, unsigned int iffsize)
{
	VQAFrameNode *curframe;
...
VQAErrorType Load_VPTZ(VQAHandleP *vqap, unsigned int iffsize)
{
	VQAFrameNode  *curframe;
	void          *buffer;
	unsigned int padsize;
...
VQAErrorType Load_SND0(VQAHandleP *vqap, unsigned int iffsize)
{
	VQAAudio      *audio;
	VQAConfig     *config;
	unsigned int padsize;
...
VQAErrorType Load_SND1(VQAHandleP *vqap, unsigned int iffsize)
{
	VQAAudio      *audio;
	VQAConfig     *config;
...
VQAErrorType Load_SND2(VQAHandleP *vqap, unsigned int iffsize)
{
	VQAAudio      *audio;
	VQAConfig     *config;
	unsigned char *loadbuf;
...
VQAErrorType Load_SN2J(VQAHandleP *vqap, unsigned int iffsize)
{
	unsigned int padsize;
	VQAConfig     *config;
	VQAAudio      *audio;
