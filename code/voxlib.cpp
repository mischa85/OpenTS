...
/*
 * Render_Object indexes this by the reversed flag, the depth buffer flag, the lighting
 * flag and the missing normals flag, in bits 0, 1, 2 and 3. Lighting has no meaning for
 * a layer that carries no normals, so the top four slots repeat the four below them.
 */
